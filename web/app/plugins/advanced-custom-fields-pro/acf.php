 ...
 * Plugin URI:    https://github.com/sewonou/advanced-custom-fields-pro
 * Description:   Customize WordPress with powerful, professional and intuitive fields.
 * Version:       99.0.0
 * Author:        Djanta Dev
 * Author URI:    https://github.com/sewonou
 * Update URI:    https://github.com/sewonou/advanced-custom-fields-pro
 * Text Domain:   acf
 * Domain Path:   /lang
 */
...
if ( ! class_exists( 'ACF' ) ) {
	...
	class ACF {
        ...
        public acf_fields $fields;

        public acf_loop $loop;

        public acf_revisions $revisions;

        public acf_validation $validation;

        public acf_form_front $form_front;

        public acf_admin_tools $admin_tools;
